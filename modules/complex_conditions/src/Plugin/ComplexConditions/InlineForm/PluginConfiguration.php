...
namespace Drupal\complex_conditions\Plugin\ComplexConditions\InlineForm;

use Drupal\complex_conditions\Element\ConditionsElementTrait;
...
class PluginConfiguration extends InlineFormBase {
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
    return new static(
      ...
      $plugin_id,
      $plugin_definition,
      $container->get('plugin.manager.complex_conditions') // . $configuration['plugin_type'])
    );
  }
