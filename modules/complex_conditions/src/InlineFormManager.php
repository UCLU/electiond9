...
use Drupal\complex_conditions\Plugin\ComplexConditions\InlineForm\EntityInlineFormInterface;
use Drupal\complex_conditions\Plugin\ComplexConditions\InlineForm\InlineFormInterface;
use Drupal\Component\Plugin\Exception\PluginException;
use Drupal\complex_conditions\Annotation\ConditionsInlineForm;
 ...
 *
 * @see \Drupal\complex_conditions\Annotation\ConditionsInlineForm
 * @see plugin_api
 */
class InlineFormManager extends DefaultPluginManager {
  ...
  public function __construct(\Traversable $namespaces, CacheBackendInterface $cache_backend, ModuleHandlerInterface $module_handler) {
    parent::__construct(
      'Plugin/ComplexConditions/InlineForm',
      $namespaces,
      $module_handler,
    ...
    $this->alterInfo('complex_conditions_inline_form_info');
    $this->setCacheBackend($cache_backend, 'complex_conditions_inline_form_plugins');
  }

  /**
   * {@inheritdoc}
   *
   * @return \Drupal\complex_conditions\Plugin\ComplexConditions\InlineForm\InlineFormInterface
