...
namespace Drupal\election_ballot_export\Form;
 ...
 * Class CountForm.
 */
class ExportBallotsForm extends BatchForm {

  /**
   * {@inheritdoc}
   */
  public function getFormId() {
    return 'election_ballot_export_form';
  }
  ...
  public function getFormTitle() {
    return $this->t('Export ballot files');
  }
}
