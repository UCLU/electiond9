...
final class ConditionGroup {
   ...
   * The conditions.
   *
   * @var \Drupal\conditions_plugin_reference\Plugin\ConditionsPluginReference\Condition\ConditionInterface[]
   */
   ...
   * Gets the conditions.
   *
   * @return \Drupal\conditions_plugin_reference\Plugin\ConditionsPluginReference\Condition\ConditionInterface[]
   *   The conditions.
   */
