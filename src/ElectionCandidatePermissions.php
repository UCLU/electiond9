...
/**
 * Provides dynamic permissions for candidates of different types.
 *
 * @ingroup election
 *
 */
class ElectionCandidatePermissions {
   ...
   *
   * @return array
   *   The candidate type by bundle permissions.
   *   @see \Drupal\user\PermissionHandlerInterface::getPermissions()
   */
  public function generatePermissions() {
    $perms = [];

    foreach (ElectionCandidateType::loadMultiple() as $type) {
   ...
   *
   * @param \Drupal\election\Entity\ElectionCandidateType $type
   *   The ElectionCandidateType type.
   *
   * @return array
   *   An associative array of permission names and descriptions.
   */
  protected function buildPermissions(ElectionCandidateType $type) {
    $type_id = $type->id();
