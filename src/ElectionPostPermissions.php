...
class ElectionPostPermissions {
   ...
   *
   * @return array
   *   The post type by bundle permissions.
   *   @see \Drupal\user\PermissionHandlerInterface::getPermissions()
   */
  public function generatePermissions() {
    $perms = [];

    foreach (ElectionPostType::loadMultiple() as $type) {
   ...
   *
   * @param \Drupal\election\Entity\ElectionPostType $type
   *   The ElectionPostType.
   *
   * @return array
   *   An associative array of permission names and descriptions.
   */
  protected function buildPermissions(ElectionPostType $type) {
    $type_id = $type->id();
