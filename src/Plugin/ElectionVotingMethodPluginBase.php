 ...
 */
abstract class ElectionVotingMethodPluginBase extends PluginBase implements ElectionVotingMethodPluginInterface {
  ...
  public function alterBallotForm(ElectionPost $electionPost) {
  }
