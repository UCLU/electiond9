...
namespace Drupal\election\Plugin\Field\FieldWidget;
...
/**
 * Plugin implementation of the 'election_post_condition_widget' widget.
 *
 * @FieldWidget(
 *   id = "election_post_condition_widget",
 *   label = @Translation("Conditions"),
 *   field_types = {
 *     "election_plugin_item:election_post_condition"
 *   },
 *   multiple_values = TRUE
 * )
 */
class ElectionPostConditionWidget extends WidgetBase implements ContainerFactoryPluginInterface {
