...
/**
 * Plugin implementation of the 'election_plugin_item' field type.
 *
 * @FieldType(
 *   id = "election_plugin_item",
 *   label = @Translation("Plugin"),
 *   description = @Translation("Stores configuration for a plugin."),
 *   category = @Translation("Election"),
 *   default_widget = "election_plugin_select",
 *   default_formatter = "election_plugin_item_default",
 *   deriver = "\Drupal\election\Plugin\Field\FieldType\ElectionPluginItemDeriver"
 * )
 */
class ElectionPluginItem extends FieldItemBase implements ElectionPluginItemInterface {
