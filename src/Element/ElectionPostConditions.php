 ...
 * @endcode
 *
 * @FormElement("election_post_conditions")
 */
class ElectionPostConditions extends FormElement {

  use ElectionElementTrait;
  ...
  public static function processConditions(array &$element, FormStateInterface $form_state, array &$complete_form) {
    ...
    $plugin_manager = \Drupal::service('plugin.manager.election_post_condition');
    ...
    $element['#attached']['library'][] = 'election/conditions';
      ...
      foreach ($definitions as $plugin_id => $definition) {
        ...
        if ($enabled) {
          ...
          $inline_form = $inline_form_manager->createInstance('plugin_configuration', [
            'plugin_type' => 'election_post_condition',
            'plugin_id' => $plugin_id,
