...
class ElectionCandidateAccessControlHandler extends EntityAccessControlHandler {
  ...
  protected function checkAccess(EntityInterface $entity, $operation, AccountInterface $account) {
    ...
    switch ($operation) {
      ...
      case 'delete':
        ...
        return AccessResult::allowedIfHasPermission($account, 'delete election candidate entities');
    }
  ...
  protected function checkCreateAccess(AccountInterface $account, array $context, $entity_bundle = NULL) {
    return AccessResult::allowedIfHasPermission($account, 'add election candidate entities');
  }
